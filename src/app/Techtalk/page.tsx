    ...
    return (
        <div className="new-page">
            ...
            <section className="relative h-screen text-white flex items-center justify-center overflow-hidden">
                ...
                {/* Content */}
                <div className="relative z-10 container mx-auto flex items-center justify-between px-6">
                    {/* Left Text */}
                    ...
                    <div className="mt-6 text-gray-100">
                        <div className="flex gap-4 text-gray-100 text-lg font-mono">
                    ...
                    style={{ transform: 'translate(-90%, -50%)' }} // Move slightly left (-90%) and up (-50%)
                    >
                    <h1 className="text-8xl font-extrabold bg-gradient-to-r text-white bg-clip-text text-transparent leading-tight">
                        Tech <br /> Talk
                    </h1>
                    </div>
                </div>
